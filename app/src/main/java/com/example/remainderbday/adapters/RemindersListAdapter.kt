...
import com.example.remainderbday.databinding.ReminderListItemBinding


class RemindersListAdapter(
    private val onCheckEventListener: (Reminders) -> Unit,
    private val onReminderClickListener: (Reminders) -> Unit
